...
class ExecutionContext(object):
    ...
    def _push(self):
        print("ExecutionContext push")
        self.stack.append(self)

    def _pop(self):
        print("ExecutionContext pop")
    ...
    def __enter__(self):
        print("ExecutionContext enter")

        self._push()
        return self

    def __exit__(self, exc_type, exc_val, exc_tb):
        print("ExecutionContext exit")
...
def get_trading_dates():
    ...
    return data_backend.get_trading_dates(ExecutionContext.get_start_date(),ExecutionContext.get_current_date())
