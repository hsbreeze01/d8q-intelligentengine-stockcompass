...
class TushareDataBackend(DataBackend):
    ...
    def get_order_book_id_list(self):
        print("TushareDataBackend.get_order_book_id_list")
        """获取所有的股票代码列表
        """
    ...
    def get_trading_dates(self, start, end):
        print("TushareDataBackend.get_trading_dates")
        """获取所有的交易日
    ...
    def symbol(self, order_book_id):
        print("TushareDataBackend.symbol")
